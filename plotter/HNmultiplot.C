...
bool multiplot() {
  ...
  TH1F* h_th1f[20][150] = {}; // [nfiles][nplots]
  ...
  cout << "Files Read, now plotting" << endl;
  ...
  for (unsigned int iplot = 0; iplot < hist1d.size(); iplot++) {
    ...
    */
    ...
    //text1->Draw("SAME");
    if ( hist1d[iplot].name().Contains("Muons/") || hist1d[iplot].name().Contains("Electrons/") || hist1d[iplot].name().Contains("Jets/") ) {
      if (hist1d[iplot].normalize()) can->Print(TString("HNplot/") + TString(hist1d[iplot].name()) + "_norm.pdf");
      else if (hist1d[iplot].log())  can->Print(TString("HNplot/") + TString(hist1d[iplot].name()) + "_log.pdf");
      else                           can->Print(TString("HNplot/") + TString(hist1d[iplot].name()) + ".pdf");
    }
    else {
      if (hist1d[iplot].normalize()) can->Print(TString("HNplot/Signal/") + TString(hist1d[iplot].name()) + "_norm.pdf");
      else if (hist1d[iplot].log())  can->Print(TString("HNplot/Signal/") + TString(hist1d[iplot].name()) + "_log.pdf");
      else                           can->Print(TString("HNplot/Signal/") + TString(hist1d[iplot].name()) + ".pdf");
    }
    delete legend;
    delete hstack;
    delete htotal;
