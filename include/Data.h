...
// Wed Mar 30 08:52:34 2016 by ROOT version 6.02/05
// from TTree event/event
// found on file: /eos/uscms/store/user/fgior8/Winter16/MajoranaNeutrinoToMM_M-100_TuneZ2star_13TeV-alpgen/Skim_31.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<double>  *metNoHF_jetEn_Px_down;
   vector<double>  *metNoHF_jetEn_Px_up;
   vector<double>  *metNoHF_jetEn_Py_down;
   vector<double>  *metNoHF_jetEn_Py_up;
   vector<double>  *metNoHF_jetEn_SumEt_down;
   vector<double>  *metNoHF_jetEn_SumEt_up;
   vector<double>  *metNoHF_jetRes_Px_down;
   vector<double>  *metNoHF_jetRes_Px_up;
   vector<double>  *metNoHF_jetRes_Py_down;
   vector<double>  *metNoHF_jetRes_Py_up;
   vector<double>  *metNoHF_jetRes_SumEt_down;
   vector<double>  *metNoHF_jetRes_SumEt_up;
   vector<double>  *metNoHF_phi;
   vector<double>  *metNoHF_pt;
   vector<double>  *metNoHF_sumet;
   vector<double>  *metNoHF_unclusteredEn_Phi_down;
   vector<double>  *metNoHF_unclusteredEn_Phi_up;
   vector<double>  *metNoHF_unclusteredEn_Px_down;
   vector<double>  *metNoHF_unclusteredEn_Px_up;
   vector<double>  *metNoHF_unclusteredEn_Py_down;
   vector<double>  *metNoHF_unclusteredEn_Py_up;
   vector<double>  *metNoHF_unclusteredEn_SumEt_down;
   vector<double>  *metNoHF_unclusteredEn_SumEt_up;
   ...
   TBranch        *b_metNoHF_jetEn_Px_down;   //!
   TBranch        *b_metNoHF_jetEn_Px_up;   //!
   TBranch        *b_metNoHF_jetEn_Py_down;   //!
   TBranch        *b_metNoHF_jetEn_Py_up;   //!
   TBranch        *b_metNoHF_jetEn_SumEt_down;   //!
   TBranch        *b_metNoHF_jetEn_SumEt_up;   //!
   TBranch        *b_metNoHF_jetRes_Px_down;   //!
   TBranch        *b_metNoHF_jetRes_Px_up;   //!
   TBranch        *b_metNoHF_jetRes_Py_down;   //!
   TBranch        *b_metNoHF_jetRes_Py_up;   //!
   TBranch        *b_metNoHF_jetRes_SumEt_down;   //!
   TBranch        *b_metNoHF_jetRes_SumEt_up;   //!
   TBranch        *b_metNoHF_phi;   //!
   TBranch        *b_metNoHF_pt;   //!
   TBranch        *b_metNoHF_sumet;   //!
   TBranch        *b_metNoHF_unclusteredEn_Phi_down;   //!
   TBranch        *b_metNoHF_unclusteredEn_Phi_up;   //!
   TBranch        *b_metNoHF_unclusteredEn_Px_down;   //!
   TBranch        *b_metNoHF_unclusteredEn_Px_up;   //!
   TBranch        *b_metNoHF_unclusteredEn_Py_down;   //!
   TBranch        *b_metNoHF_unclusteredEn_Py_up;   //!
   TBranch        *b_metNoHF_unclusteredEn_SumEt_down;   //!
   TBranch        *b_metNoHF_unclusteredEn_SumEt_up;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms/store/user/fgior8/Winter16/MajoranaNeutrinoToMM_M-100_TuneZ2star_13TeV-alpgen/Skim_31.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/uscms/store/user/fgior8/Winter16/MajoranaNeutrinoToMM_M-100_TuneZ2star_13TeV-alpgen/Skim_31.root");
      }
...
void Data::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("metNoHF_jetEn_Px_down", &metNoHF_jetEn_Px_down, &b_metNoHF_jetEn_Px_down);
   fChain->SetBranchAddress("metNoHF_jetEn_Px_up", &metNoHF_jetEn_Px_up, &b_metNoHF_jetEn_Px_up);
   fChain->SetBranchAddress("metNoHF_jetEn_Py_down", &metNoHF_jetEn_Py_down, &b_metNoHF_jetEn_Py_down);
   fChain->SetBranchAddress("metNoHF_jetEn_Py_up", &metNoHF_jetEn_Py_up, &b_metNoHF_jetEn_Py_up);
   fChain->SetBranchAddress("metNoHF_jetEn_SumEt_down", &metNoHF_jetEn_SumEt_down, &b_metNoHF_jetEn_SumEt_down);
   fChain->SetBranchAddress("metNoHF_jetEn_SumEt_up", &metNoHF_jetEn_SumEt_up, &b_metNoHF_jetEn_SumEt_up);
   fChain->SetBranchAddress("metNoHF_jetRes_Px_down", &metNoHF_jetRes_Px_down, &b_metNoHF_jetRes_Px_down);
   fChain->SetBranchAddress("metNoHF_jetRes_Px_up", &metNoHF_jetRes_Px_up, &b_metNoHF_jetRes_Px_up);
   fChain->SetBranchAddress("metNoHF_jetRes_Py_down", &metNoHF_jetRes_Py_down, &b_metNoHF_jetRes_Py_down);
   fChain->SetBranchAddress("metNoHF_jetRes_Py_up", &metNoHF_jetRes_Py_up, &b_metNoHF_jetRes_Py_up);
   fChain->SetBranchAddress("metNoHF_jetRes_SumEt_down", &metNoHF_jetRes_SumEt_down, &b_metNoHF_jetRes_SumEt_down);
   fChain->SetBranchAddress("metNoHF_jetRes_SumEt_up", &metNoHF_jetRes_SumEt_up, &b_metNoHF_jetRes_SumEt_up);
   ...
   fChain->SetBranchAddress("metNoHF_unclusteredEn_Phi_down", &metNoHF_unclusteredEn_Phi_down, &b_metNoHF_unclusteredEn_Phi_down);
   fChain->SetBranchAddress("metNoHF_unclusteredEn_Phi_up", &metNoHF_unclusteredEn_Phi_up, &b_metNoHF_unclusteredEn_Phi_up);
   fChain->SetBranchAddress("metNoHF_unclusteredEn_Px_down", &metNoHF_unclusteredEn_Px_down, &b_metNoHF_unclusteredEn_Px_down);
   fChain->SetBranchAddress("metNoHF_unclusteredEn_Px_up", &metNoHF_unclusteredEn_Px_up, &b_metNoHF_unclusteredEn_Px_up);
   fChain->SetBranchAddress("metNoHF_unclusteredEn_Py_down", &metNoHF_unclusteredEn_Py_down, &b_metNoHF_unclusteredEn_Py_down);
   fChain->SetBranchAddress("metNoHF_unclusteredEn_Py_up", &metNoHF_unclusteredEn_Py_up, &b_metNoHF_unclusteredEn_Py_up);
   fChain->SetBranchAddress("metNoHF_unclusteredEn_SumEt_down", &metNoHF_unclusteredEn_SumEt_down, &b_metNoHF_unclusteredEn_SumEt_down);
   fChain->SetBranchAddress("metNoHF_unclusteredEn_SumEt_up", &metNoHF_unclusteredEn_SumEt_up, &b_metNoHF_unclusteredEn_SumEt_up);
