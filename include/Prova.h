...
// Mon Oct 12 06:06:52 2015 by ROOT version 6.02/05
// from TTree event/event
// found on file: /eos/uscms/store/user/fgior8/Spring15/DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/Skim_1.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms/store/user/fgior8/Spring15/DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/Skim_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/uscms/store/user/fgior8/Spring15/DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/Skim_1.root");
      }
